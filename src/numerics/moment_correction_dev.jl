...
@noinline function correct_moments_dev(
    ...
    begin
        ...
        C400 = m5*t8 - (m2*m2)^2*t11*3.0 - m2*m4*t9*4.0 + m3*m2^2*t10*6.0
        C110 = m7*t8 - m6*m2*t9
        ...
        C040 = m15*t8 - (m6*m6)^2*t11*3.0 - m6*m13*t9*4.0 + m10*m6^2*t10*6.0
        ...
        C004 = m25*t8 - (m16*m16)^2*t11*3.0 - m16*m23*t9*4.0 + m20*m16^2*t10*6.0
