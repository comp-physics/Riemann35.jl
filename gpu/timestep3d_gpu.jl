...
function march3d_gpu!(M_dev::CuArray{Float64,4}, dx::Real, Ma::Real, nstep::Integer;
                      dts=nothing, vacuum_floor::Real=HO_VACUUM_FLOOR_DEFAULT, order::Int=2, proj_first_order::Bool=false, threads::Int=128)
    ...
    L! = (Rint, st) -> residual3d_box_gpu!(Rint, st, nx, ny, nz, dxf, Maf;
                                           ...
                                           order=order, proj_first_order=proj_first_order, threads=threads, flat=flat)
...
function march3d_slab_gpu!(M::CuArray{Float64,4}, dx::Real, Ma::Real, nstep::Integer, comm;
                           halo::Int=2, dts=nothing, vacuum_floor::Real=HO_VACUUM_FLOOR_DEFAULT, order::Int=2, proj_first_order::Bool=false,
                           threads::Int=128)
    ...
    L! = function (Rout, state)
        ...
        residual3d_box_gpu!(Rext, Mext, n, n, nz_ext, dxf, Maf;
                            vacuum_floor=vacf, project_faces=true, order=order, proj_first_order=proj_first_order, threads=threads, flat=flat)
